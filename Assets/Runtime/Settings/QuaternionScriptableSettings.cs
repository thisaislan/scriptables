...
namespace Thisaislan.Scriptables
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = nameof(QuaternionScriptableSettings), menuName = RuntimeConsts.ScriptableSettingsMenuPath + nameof(QuaternionScriptableSettings), order = 9)]
    /// <summary>
