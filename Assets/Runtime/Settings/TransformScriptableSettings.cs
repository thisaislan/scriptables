...
namespace Thisaislan.Scriptables
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = nameof(TransformScriptableSettings), menuName = RuntimeConsts.ScriptableSettingsMenuPath + nameof(TransformScriptableSettings), order = 8)]
    /// <summary>
