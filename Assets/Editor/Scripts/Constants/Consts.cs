...
namespace Thisaislan.Scriptables.Editor
{
    ...
    internal class Consts
    {
        ...
        internal const string DefaultReactiveMethodName = "Static";
        ...
        internal const string RuntimeObserversSectionTitle = "Runtime Observers";
        internal const string NoObserversRegisteredMessage =  "No observers registered.";
